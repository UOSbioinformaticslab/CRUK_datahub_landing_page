...
export const getAdvancedFilterSteps = (params = {}) => {
  const {
    setActivePanel,
  ...
  return [
    {
      ...
      content: 'Goal: You are currently on the Dashboard. To run the Advanced Filters & Logic demonstration, click "Browse or Search Datasets" to navigate to the Datasets filter catalogue.',
      onEnter: () => {}
    },
    {
