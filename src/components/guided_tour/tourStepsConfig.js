// Configuration for Guided Tour Steps
...
export const getTourSteps = ({
...
}) => [
  {
    ...
    title: 'Step 1: Cancer Type Selection',
    content: 'Click "Which Cancers are you interested in?" to open the panel for selecting cancer classifications.',
    onEnter: () => {
