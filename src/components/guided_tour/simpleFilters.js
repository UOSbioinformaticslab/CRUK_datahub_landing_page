...
export const getSimpleFilterSteps = (params = {}) => {
  const {
    setActivePanel,
  ...
  return [
    {
      ...
      content: 'Goal: You are currently on the Dashboard. To run the Simple Filters demonstration, click "Browse or Search Datasets" to navigate to the Datasets filter catalogue.',
      onEnter: () => {}
    },
    {
